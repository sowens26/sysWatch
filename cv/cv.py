...
face_cascades = [ cv2.CascadeClassifier('cascades/frontal.xml'),\
    cv2.CascadeClassifier('cascades/frontal2.xml'),\
    cv2.CascadeClassifier('cascades/frontal3.xml'),\
    cv2.CascadeClassifier('cascades/frontal4.xml')];

def getFaces(image_array) -> [tuple]:
    faces = []
    faces.append( face_cascades[0].detectMultiScale(image_array, scaleFactor=1.5, minNeighbors=5) )
    faces.append( face_cascades[1].detectMultiScale(image_array, scaleFactor=1.5, minNeighbors=5) )
    faces.append( face_cascades[2].detectMultiScale(image_array, scaleFactor=1.5, minNeighbors=5) )
    faces.append( face_cascades[3].detectMultiScale(image_array, scaleFactor=1.5, minNeighbors=5) )
    return faces 
